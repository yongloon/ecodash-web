...
import { usePathname } from 'next/navigation'; // Now correctly used in a Client Component
...
import { LogIn, LogOut, Gem } from 'lucide-react'; // Added Gem for Upgrade example
...
export default function Header() {
  ...
  // This relies on hasActiveSubscription being added to your session object via NextAuth callbacks
  const userHasActiveSubscription = (session?.user as any)?.hasActiveSubscription === true;
